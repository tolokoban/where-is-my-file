...
import NicknameView, { INicknameViewProps } from './nickname-view'

function view(partialProps: Partial<INicknameViewProps>) {
    const props: INicknameViewProps = {
        // @TODO Set default props.
        ...partialProps
    }
    return Renderer.create(<NicknameView {...props} />).toJSON()
}

describe('<NicknameView/> in view', () => {
